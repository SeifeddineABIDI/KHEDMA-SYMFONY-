...
class __TwigTemplate_8ac573b29c85549bed9264c2b77d7cdc extends Template
{
    private $source;
    private $macros = [];
...
.column.over {
  ...
  <button onclick=\"window.location.href='{{ path('app_tache_new', {'projetId': projetId}) }}'\">Add Task</button>
         ...
         {% endblock %}", "FrontOffice/project/tasheshow.html.twig", "C:\\Users\\Safe\\Downloads\\PIDEV-SYMFONY (1)\\templates\\FrontOffice\\project\\tasheshow.html.twig");
    }
}
