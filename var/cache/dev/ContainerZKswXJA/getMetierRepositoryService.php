 ...
 */
class getMetierRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MetierRepository' shared autowired service.
     *
     * @return \App\Repository\MetierRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MetierRepository.php';

        return $container->privates['App\\Repository\\MetierRepository'] = new \App\Repository\MetierRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
