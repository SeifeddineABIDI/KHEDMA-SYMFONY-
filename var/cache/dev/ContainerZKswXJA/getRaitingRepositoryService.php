 ...
 */
class getRaitingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RaitingRepository' shared autowired service.
     *
     * @return \App\Repository\RaitingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RaitingRepository.php';

        return $container->privates['App\\Repository\\RaitingRepository'] = new \App\Repository\RaitingRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
