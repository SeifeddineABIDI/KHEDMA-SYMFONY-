 ...
 */
class getSousMetierRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SousMetierRepository' shared autowired service.
     *
     * @return \App\Repository\SousMetierRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SousMetierRepository.php';

        return $container->privates['App\\Repository\\SousMetierRepository'] = new \App\Repository\SousMetierRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
