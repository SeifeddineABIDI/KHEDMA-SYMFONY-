 ...
 */
class getClassificationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClassificationRepository' shared autowired service.
     *
     * @return \App\Repository\ClassificationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClassificationRepository.php';

        return $container->privates['App\\Repository\\ClassificationRepository'] = new \App\Repository\ClassificationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
