...
class AnnonceController extends AbstractController
{
    ...
    public function new(Request $request, AnnonceRepository $annonceRepository): Response
    {
        ...
        return $this->renderForm('BackOffice/annonce/new.html.twig', [
            'annonce' => $annonce,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('BackOffice/annonce/show.html.twig', [
            'annonce' => $annonce,
        ]);
    }
    ...
    public function edit(Request $request, Annonce $annonce, AnnonceRepository $annonceRepository): Response
    {
        ...
        return $this->renderForm('BackOffice/annonce/edit.html.twig', [
            'annonce' => $annonce,
            'form' => $form,
        ]);
    }
