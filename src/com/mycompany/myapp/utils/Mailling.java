...
public boolean sendemaill(String titre,String description)
{
...
message.setRecipients(
  Message.RecipientType.TO, InternetAddress.parse("rahma.farhat@esprit.tn"));
message.setSubject("Notification");


String msg = "New Event called "+titre+"\nDescription :\n"+description;
