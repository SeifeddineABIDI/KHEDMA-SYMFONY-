...
public class StatistiquePieForm extends BaseForm {
    ...
    private double nbr_Metier = 45;
    private double nbr_SousMetier = 29;
...
BaseForm form;
        ...
        RadioButton all = RadioButton.createToggle("Metier", barGroup);
       
        all.setUIID("SelectBar");
        RadioButton popular = RadioButton.createToggle("Metier", barGroup);
        popular.setUIID("SelectBar");
        RadioButton feedback = RadioButton.createToggle("SousMetier", barGroup);
  ...
  ;       
       ...
       image.addActionListener(e -> {
           try{
           new AddMetierForm(Resources.getGlobalResources()).show();
           }catch(Exception exx) {
    ...
    public void createPieChartForm() {
        ...
        double total = nbr_Metier + nbr_SousMetier;
        
        //values
        double prcntFeed = (nbr_Metier *100)/total;
        
        double prcntRec = (nbr_SousMetier * 100)/total;
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        series.add("Metier",prcntRec);
        series.add("Sous Metier",prcntFeed);
